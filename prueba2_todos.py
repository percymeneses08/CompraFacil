...
def get_title_prueba(producto1):
...
categoria_dic = {'Totus': supermarket_dic};
...
for url in div_url:
    ...
    for i in ids:
        ...
        producto_dic={'Producto': titulos, 'Supermercado': 'Totus', 'Precio': precio, 'Marca': marcas, 'Categoria': categoria,'Precio_float': precio}

        supermarket_dic.setdefault('Producto'+str(contador), producto_dic);

        diccionario.setdefault(categoria, categoria_dic);
