...
soup=get_content_url('/tottus/browse/Aceites/1.01');
...
data = {'Producto': array1_2,'Subtitulo':array4,'Price':array6,'Marca':array2_1}
...
export = df.to_json('tottus_leche.json')
